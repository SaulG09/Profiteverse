...
public class DatosDueno extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_datos_dueno);
        ...
        MaterialCardView foto = findViewById(R.id.cambiarFotoDueno);
        nombre = findViewById(R.id.textoNombreDueno);
        telefono = findViewById(R.id.textoTelefonoDueno);
        cr = findViewById(R.id.fotoDueno);
        MaterialButton finalizar = findViewById(R.id.finalizarDueno);
        ...
        finalizar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (fotoUrl != null) {
                    if (nuevoTelefono.isEmpty() || nuevoNombre.isEmpty()) {
                        Toast.makeText(DatosDueno.this, "Por favor completa todos los campos.", Toast.LENGTH_SHORT).show();
                    }else {
                        // Actualizar en Firestore
                        db.collection("Dueno").document(idUser)
                                .update(datosActualizados)
                                .addOnSuccessListener(aVoid -> Toast.makeText(DatosDueno.this, "Datos actualizados", Toast.LENGTH_SHORT).show())
                                .addOnFailureListener(e -> Toast.makeText(DatosDueno.this, "Error al actualizar los datos", Toast.LENGTH_SHORT).show());

                        if (tipo.equals("Dueno")) {
                    Intent intent = new Intent(DatosDueno.this,  Dueno.class);
                    ...
                    Toast.makeText(DatosDueno.this, "Sube una foto primero.", Toast.LENGTH_SHORT).show();
        ...
        if (requestCode == CAMERA_REQUEST_CODE && resultCode == RESULT_OK) {
            if (data != null && data.getExtras() != null) {
                ...
                if (photoBitmap != null) {
                    ...
                    ConstraintLayout cr = findViewById(R.id.fotoDueno);
                    ...
                    subirFoto(photoBitmap, new OnUploadCompleteListener() {
                        ...
                        public void onUploadComplete(String url) {
                            ...
                            Toast.makeText(DatosDueno.this, "Foto subida: " + url, Toast.LENGTH_SHORT).show();
                        ...
                        public void onUploadFailed(Exception e) {
                            // Maneja el error
                            Toast.makeText(DatosDueno.this, "Error al subir la foto: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            }
