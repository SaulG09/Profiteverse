...
public class VerRutinasUsuario extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ver_rutinas_usuario);
        mAuth = FirebaseAuth.getInstance();
        db = FirebaseFirestore.getInstance();
        FirebaseUser currentUser = FirebaseAuth.getInstance().getCurrentUser();
        Intent intent = getIntent();
        idRutina = intent.getStringExtra("ID_COACH");
        gridLayout = findViewById(R.id.gridRutinasUsuario);
    ...
    private void agregarRutinaAlGrid(DocumentSnapshot document) {
        ...
        cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(VerRutinasUsuario.this, ConsultaRutinaUsuario.class);
                intent.putExtra("ID_RUTINA", document.getId());
                intent.putExtra("ID_COACH", idRutina);
