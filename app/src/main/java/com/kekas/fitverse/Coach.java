...
public class Coach extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout ly = findViewById(R.id.fotoCoach2);
        TextView tv = findViewById(R.id.nombreCoach);

        MaterialCardView info = findViewById(R.id.botonInformacionCoach);
        MaterialCardView ruti = findViewById(R.id.botonRutinasCoach);
        MaterialCardView gyms = findViewById(R.id.botonGymsCoach);

        gyms.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Coach.this, Gyms.class);
        ...
        ruti.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Coach.this, Rutinas.class);
                intent.putExtra("USER_ID", idUser);
                intent.putExtra("TIPO", "Coach");
                startActivity(intent);
            }
        ...
        info.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Coach.this,Informacion.class);
                intent.putExtra("USER_ID", idUser);
                intent.putExtra("TIPO", "Coach");
                startActivity(intent);
            }
        ...
        MaterialCardView salir = findViewById(R.id.botonCerrarSesion);
        salir.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mGoogleSignInClient.signOut().addOnCompleteListener(task -> {
                    ...
                    Intent intent = new Intent(Coach.this, MainActivity.class);
        ...
        MaterialCardView editar = findViewById(R.id.editarInfo);
        editar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Cerrar sesión de Firebase
                    Intent intent = new Intent(Coach.this, DatosCoach.class);
                    intent.putExtra("USER_ID", idUser);
                    intent.putExtra("TIPO", "Coach");
                    startActivity(intent);
                    finish();
