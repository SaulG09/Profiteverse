...
public class AgregarEjercicio extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nombre = findViewById(R.id.textoNombreEjercicio);
        descripcion = findViewById(R.id.textoDescripcionEjercicio);
        enfoque = findViewById(R.id.textoSeriesEjercicio);
        duracion = findViewById(R.id.textoRepeticionesEjercicio);
        cr = findViewById(R.id.fotoEjercicio);
        MaterialButton agregar = findViewById(R.id.botonAgregarEjercicio);
        ...
        agregar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                entrenamiento.put("id_rutina", idRutina);
                ...
                db.collection("Coach").document(currentUser.getUid()).collection("Rutinas").document(idRutina).collection("Ejercicios")
                        .add(entrenamiento)
    ...
    private void actualizarFoto(Bitmap bitmap) {
        ...
        subirFoto(bitmap, new OnUploadCompleteListener() {
            ...
            public void onUploadComplete(String url) {
                Toast.makeText(AgregarEjercicio.this, "Foto subida: " + url, Toast.LENGTH_SHORT).show();
                fotoUrl = url;
            }

            @Override
            public void onUploadFailed(Exception e) {
                Toast.makeText(AgregarEjercicio.this, "Error al subir la foto: " + e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
