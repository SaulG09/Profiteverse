...
public class DatosCoach extends AppCompatActivity {
    ...
    EditText nombre;
    EditText telefono;
    EditText especializacion;
    ConstraintLayout cr;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_datos_coach);
        ...
        MaterialCardView foto = findViewById(R.id.cambiarFoto);
        nombre = findViewById(R.id.textoNombre);
        telefono = findViewById(R.id.textoTelefono);
        especializacion = findViewById(R.id.textoEspecializacion);
        cr = findViewById(R.id.fotoCoach);
        MaterialButton finalizar = findViewById(R.id.finalizar);
        ...
        finalizar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String nuevaEspecializacion = especializacion.getText().toString().trim();

                // Validar que los campos no estén vacíos
                if (nuevoNombre.isEmpty() || nuevoTelefono.isEmpty() || nuevaEspecializacion.isEmpty()) {
                    // Mostrar un mensaje si algún campo está vacío
                    Toast.makeText(DatosCoach.this, "Por favor, completa todos los campos", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    if (fotoUrl != null) {
                        ...
                        db.collection("Coach").document(idUser)
                                .update(datosActualizados)
                                .addOnSuccessListener(aVoid -> Toast.makeText(DatosCoach.this, "Datos actualizados", Toast.LENGTH_SHORT).show())
                                .addOnFailureListener(e -> Toast.makeText(DatosCoach.this, "Error al actualizar los datos", Toast.LENGTH_SHORT).show());

                        // Si es un coach, redirigir al perfil del coach
                        if (tipo.equals("Coach")) {
                            Intent intent = new Intent(DatosCoach.this, Coach.class);
                            intent.putExtra("ID_USER", idUser);
                            startActivity(intent);
                            finish();
                        }
                    }else{
                        Toast.makeText(DatosCoach.this, "Sube una foto primero.", Toast.LENGTH_SHORT).show();
        ...
        if (idUser != null) {
            obtenerNombreUsuario(idUser, nombre, cr, telefono, especializacion);
        }
    }
        ...
        if (requestCode == CAMERA_REQUEST_CODE && resultCode == RESULT_OK) {
            if (data != null && data.getExtras() != null) {
                ...
                if (photoBitmap != null) {
                    ...
                    ConstraintLayout cr = findViewById(R.id.fotoCoach);
                    ...
                    subirFoto(photoBitmap, new OnUploadCompleteListener() {
                        ...
                        public void onUploadComplete(String url) {
                            ...
                            Toast.makeText(DatosCoach.this, "Foto subida: " + url, Toast.LENGTH_SHORT).show();
                        ...
                        public void onUploadFailed(Exception e) {
                            // Maneja el error
                            Toast.makeText(DatosCoach.this, "Error al subir la foto: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            }
    ...
    private void obtenerNombreUsuario(String userId, EditText nombreEditText, ConstraintLayout cr, EditText tele, EditText esp) {
